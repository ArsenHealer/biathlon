<template>
  <v-container>
    ...
    <v-row>
      ...
      >
        <v-card
          ...
          hover
          link
          href="https://t.me/+P8-HpGv9IdU3NDM6"
        >
      ...
      >
        <v-card
          ...
          hover
          link
          href="https://vk.com/club228675930"
        >
          <v-card-text class="text-h6">
            Танковый биатлон
          </v-card-text>
    ...
    <v-row>
      ...
      <v-col>
        <p>
          Вы можете посетить танковую выставку в центральном парке "Патриот" в Московской области недалеко от
        ...
        <button @click="$yandexMetrika.hit('https://tank-biathlon.tw1.ru/about')" />
      </v-col>
    </v-row>
  </v-container>
</template>